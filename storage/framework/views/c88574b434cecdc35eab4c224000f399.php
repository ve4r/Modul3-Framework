...
<body>
    <div class="container m-5">
        ...
        <div class="list-group mt-4">
            <a href="<?php echo e(url('/bootstrapclone')); ?>" class="list-group-item list-group-item-action">
                Bootstrap Clone
            </a>
        </div>
...
<?php /**PATH E:\Kuliah\Semester 4\Framework\modul3\RoutingBundlingAsset\resources\views/routing.blade.php ENDPATH**/ ?>